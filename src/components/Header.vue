<template>
  <header class="flex justify-between pt-12 px-6 md:px-16 m-auto max-w-5xl text-left">
    <div class="flex font-bold items-center text-[22px] sm:text-3xl">
      <span class="text-purple-500 tracking-tighter whitespace-nowrap">crypt
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 sm:h-5 inline -ml-[5px] sm:-ml-1.5 -mr-[1.5px] -mt-[1px] w-4 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
