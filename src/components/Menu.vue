<template>
  <div class="duration-300 fixed h-full left-0 top-0 transition w-full z-20">
    <div class="backdrop-blur-[2px] bg-black/10 dark:bg-white/10 duration-300 flex h-full overflow-y-auto p-4 py-12 relative transition w-full" @click.self="closeSettings">
      <div class="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 max-w-5xl mt-auto mx-auto px-4 py-6 relative rounded-lg shadow-lg w-full">
        ...
        <div class="pb-10">
          <label class="font-medium text-sm" for="currency">select primary currency</label>
          <select class="dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-500 mt-1 p-2 md:p-3 rounded-md md:text-lg" name="currency" id="">
        ...
        <div>
          <button class="border border-neutral-300 flex items-center justify-center py-2 rounded-full text-red-500 w-full">
            ...
            <span class="text-medium">clear all saved coins</span>
          </button>
        </div>
      </div>        
    </div>
