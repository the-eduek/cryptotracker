    ...
    <form class="m-auto pt-4 md:pt-6 pb-20" @submit.prevent="calculate(amount)">
      ...
      <div class="flex flex-col md:flex-row items-center py-14 md:justify-center">
        <div>
          ...
          <select class="bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-500 duration-300 my-2 dark:outline-purple-50 p-2 md:p-3 rounded-md md:text-lg transition" v-model="convertFrom" id="currency" title="currency to convert from">
        ...
        <div>
          ...
          <select class="bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-500 duration-300 my-2 dark:outline-purple-50 p-2 md:p-3 rounded-md md:text-lg transition" v-model="convertTo" id="crypto" title="crpyto to convert to">
            <option 
